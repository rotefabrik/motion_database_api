"""
Django settings for motion_database project.
...
SECRET_KEY = '(l%8!773)xt%(1_*nr56kob53-1=1&1=++ws^+jp6%&e1l7lo='
...
ROOT_URLCONF = 'motion_database.urls'
...
WSGI_APPLICATION = 'motion_database.wsgi.application'
